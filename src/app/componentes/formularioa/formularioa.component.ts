...
import { Alumno, seccionAlum, historial} from './../../modelos/alumno'
@Component({
...
export class FormularioaComponent  {
  ...
  //Cambiar los datos del historial
  public cFecha(evento: Event): void{
    const ele = evento.target as HTMLInputElement;
    this.historial.fecha = ele.value;
  }
  public cHora(evento: Event): void{
    const ele = evento.target as HTMLInputElement;
    this.historial.hora = ele.value;
  }

  //Cambiar los datos y ingresar nuevos alumnos
